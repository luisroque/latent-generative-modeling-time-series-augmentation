...
DESCRIPTION = "Robust time series lgta for forecasting algorithms"
LONG_DESCRIPTION = (
    "A package that allows to augment your time series dataset "
...
def get_version():
    VERSIONFILE = join("lgta", "__init__.py")
