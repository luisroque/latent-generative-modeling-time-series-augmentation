...
| **Diffusion-TS** | 2024 | ICLR | [Y-debug-sys/Diffusion-TS](https://github.com/Y-debug-sys/Diffusion-TS) (original); our PyTorch port in `lgta/benchmarks/diffusion_ts/` |
...
- **Diffusion-TS:** Yuan, X. & Qiao, Y. (2024). *Diffusion-TS: Interpretable Diffusion for General Time Series Generation.* ICLR.
